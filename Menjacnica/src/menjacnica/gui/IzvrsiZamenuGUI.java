...
public class IzvrsiZamenuGUI extends JFrame {
		...
		if (btnIzvrsiZamenu == null) {
			...
			btnIzvrsiZamenu.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.izvrsiZamenu(valuta, rdbtnProdaja.isSelected(), 
							textFieldIznos.getText(), textFieldKonacniIznos);
				}
			});
	...
	private void prikaziValutu(){
		GUIKontroler.prikaziValutu(null, textFieldValuta, null, textFieldProdajniKurs, textFieldKupovniKurs, null, null);;
	}
